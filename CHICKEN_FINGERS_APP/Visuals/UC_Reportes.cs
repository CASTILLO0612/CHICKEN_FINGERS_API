...
namespace CHICKEN_FINGERS_APP.Visuals
{
    public partial class UC_Reportes : UserControl
    {
        ...
        public UC_Reportes(ApiClient apiClient)
        {
            InitializeComponent();
        ...
        private async void btnHacerReporte_Click(object sender, EventArgs e)
        {
            // Await the asynchronous method to get the data
            var datos = await _apiClient.Reportes.ObtenerReporteClientes(dtpInicio.Value, dtpFin.Value);
